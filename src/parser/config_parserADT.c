...
#define SUC_NEW_TRANSFORMATION_TRUE "+SUC New transformation: true\n"
#define SUC_NEW_TRANSFORMATION_FALSE "+SUC New transformation: false\n"
#define SUC_TRANSFORMATION_TRUE "+SUC Transformation: true\n"
#define SUC_TRANSFORMATION_FALSE "+SUC Transformation: false\n"
